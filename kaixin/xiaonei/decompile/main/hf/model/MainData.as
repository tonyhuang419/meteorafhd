package hf.model
{
    ...
    public class MainData extends EventDispatcher
    {
        ...
        public static const DOG_FEED:String = "dogFeed";
        ...
        public function set dogFeed(param1:Object) : void
        {
            ...
            dispatchEvent(new ModelEvent(MainData.DOG_FEED));
            return;
        }// end function
        ...
        public function get dogFeed() : Object
        {
            return _dogFeed;
        }// end function
