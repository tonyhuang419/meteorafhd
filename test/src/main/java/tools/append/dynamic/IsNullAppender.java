 ...
 */
public class IsNullAppender extends SingleConditionAppender {
	/**
	 * @param appendString  要追加的字符串
	 * @param conditionValue 用于判断的条件
	 */
	public IsNullAppender(String appendString, Object conditionValue) {
	 ...
	 * @param conditionValue 用于判断的条件
	 */
	public IsNullAppender(String prepend, String appendString,
	 ...
	 */
	public IsNullAppender(String appendString, Object conditionValue,Object parameter) {
		this.conditionValue = conditionValue;
		this.appendString = appendString;
	...
	public boolean isAppend() {
		return JudgeUtils.isNull(conditionValue);
	}
}
