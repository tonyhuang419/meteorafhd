...
<html>
<head>
<title>增票已开未签搜索</title>

<script language="javascript">
function getEmployeeOfDepartment(departmentCode){
		ajaxSetSelectOptions("/yx/jsonData.action?method=doGetEmployeeOfDepartment&departmentCode="+departmentCode,document.vATInvoiceNoSign.expId,"id","name",{value:"",text:"    "});
}
...
function validate()
{
	var ev = new Validator();
	  with(vATInvoiceNoSignFormSearch){
...
<s:hidden name="resetCondition" value="true"/>
	...
	<iframe	name="errorsFrame" frameborder="0" framespacing="0" height="0" scrolling="no"></iframe></div>
	      ...
	      <tr class="bg_table02">
	       ...
	       <tr class="bg_table02">
		          ...
		          <select name="billType">
					<option value="2" <s:if test="#parameters.billType[0] == 2">selected</s:if> >增票</option>
					<option value="3" <s:if test="#parameters.billType[0] == 3">selected</s:if> >商票</option>
				</select>
			</td>
	      </tr>     
          <tr class="bg_table02">
