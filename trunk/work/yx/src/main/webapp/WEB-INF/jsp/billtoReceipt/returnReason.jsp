...
<script type="text/javascript">
	...
	function save(){
		if(!validate()){
			document.billApplyVerify.submit();
		}
	}
</script>
<body>
<div align="left" style="color:#000 ">
  当前页面：开票管理 -> 开票申请确认->退回申请理由
</div>
<iframe name="errorsFrame" frameborder="0"
							framespacing="0" height="0" width="100%" scrolling="no"></iframe>
	<s:form action="billApplyVerify" theme="simple">
	<s:hidden name="method" value="verifyStateT"></s:hidden>
	<s:hidden name="billApplyId" value="%{#parameters.billApplyId}" ></s:hidden>
