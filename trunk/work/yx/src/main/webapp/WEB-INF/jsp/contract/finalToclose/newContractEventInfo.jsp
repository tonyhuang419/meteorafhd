  ...
  <tr class="bg_table02">
    <td colspan="4" align="center" class="bg_table02"><div id="container" class="bg_table02">
      ...
      <div id="content" class="content1" >
          <div  id="content1"  >
			...
			<table align="center" border="1" bordercolor="#808080" style=" border-collapse: collapse;"
				...
				<s:iterator id="infoPart" value="mainInfoPartList"
					status="partIndex">
					<tr>
						<td colspan="3" class="bg_table01" align="left"><input
       ...
       <div align="center">
          <input  type="button" value="保存"  onClick="if(!validate()){setNum(3);document.finalToclose.submit();}" class="button01" >   
...
function tijiao()
{
	document.finalToclose.method.value="applySubmitByItemInfo";
	...
	{
		var ev2=new Validator();
		var count = document.finalToclose.itemInfoIndex.value;
		for(var k=0;k<count;k++){
			var partMoney = document.finalToclose.elements("itemInfoList["+k+"].conItemAmountWithTax").value;
     		ev2.test("float","项目费用总金额必须为大于0的数字！",partMoney);
		}
		ev2.writeErrors(errorsFrame, "errorsFrame");
        if(ev2.size()>0){
         return true;
