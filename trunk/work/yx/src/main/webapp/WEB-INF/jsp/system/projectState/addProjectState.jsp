	...
	<tr>
		<td valign="top" align="center">
			...
			<table width="94%" border="0" cellspacing="1" cellpadding="1">
				<tr>
					<td class="txt_title01" height="3" align="center">项目状态新增</td>
				</tr>
				<tr>
			...
			<s:form  action="projectState" theme="simple">
					<s:hidden name="method" value="saveProjectState" />
				<table width="94%" border="0" cellspacing="1" cellpadding="1">
					<tr align="center">
						<td class="bg_table02" width="40%" align="right">项目状态类型：</td>
						<td class="bg_table02" align="left">
							<s:textfield name="ps.type" />
						</td>
					</tr>
