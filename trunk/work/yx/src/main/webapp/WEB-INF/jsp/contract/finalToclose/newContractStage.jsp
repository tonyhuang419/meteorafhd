...
<body style="background-color: #FFFFFF;">
 <s:form name="finalToclose" action="finalToclose" theme="simple">
    	<!-- 切换tab页参数 -->
...
<table width="100%" height="100%" border="0"  align="center" cellpadding="1" cellspacing="1" class="bg_table02">
  ...
  <tr class="bg_table02">
    <td colspan="4" align="center" class="bg_table02"><div id="container" class="bg_table02">
          ...
          <div id="content4"   >
              ...
              <!--开票和收款计划开始-->
               <table align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#808080" style=" border-collapse: collapse;" width="100%">
                ...
                <tr>
                  <td class="bg_table01" colspan="6"><div align="left"><s:property value="typeManageService.getYXTypeManage(1012,#maininfoPart[0].moneytype).typeName"/>&nbsp;&nbsp;&nbsp;&nbsp;总金额:<s:property value="#maininfoPart[0].money"/>&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                </tr>
                  	<tr>
        ...
        <div align="center">
          <input  type="button" value="保存"  onClick="if(!validate()){setNum(2);document.finalToclose.submit();}" class="button01" >   
...
function tijiao()
{
	document.finalToclose.method.value="applySubmitByStagePlan";
...
function validate(){
 	var ev2=new Validator();
 	var count = document.finalToclose.stagePlanIndex.value;
 	for(var k=0;k<count;k++){
 		var planReveMoney = document.finalToclose.elements("stagePlanlist["+k+"].reveAmount").value;
 		var planStageMoney = document.finalToclose.elements("stagePlanlist["+k+"].stageAmout").value;
