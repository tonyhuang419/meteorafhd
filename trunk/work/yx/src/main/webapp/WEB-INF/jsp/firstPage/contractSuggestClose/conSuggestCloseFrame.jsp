...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="250" id="td1" style="display:block"><iframe src="/yx/firstPage/contractSuggestClose.action" 
    ...
    <td width="*"><iframe src="/yx/firstPage/contractSuggestClose.action?method=right" width="100%" id="rightiframe" frameborder="0" height="100%" name="content"></iframe></td>
  </tr>
</table>
</body>
</html>
