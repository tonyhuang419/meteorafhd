...
<s:form action="programEconomyVerifyQuery" target="content" theme="simple">
   <s:hidden name="a" id="a"/>
			...
			<table align="center" border=0 cellpadding=1 cellspacing=1
				width="100%">
				<tr>
					<td align="left">当前页面：工程经济->工程经济确认</td>
				</tr>
				<tr>
			...
			<table align="center" border=1 cellpadding="1" cellspacing=1
				...
				<s:iterator id="result" value="info.result">
					<tr align="center" onMouseOver="this.bgColor='#BBBBFF'; "
						...
						<td align="left" onclick="openUrl('programEconomy.action?method=projectInfo&pid=<s:property value="#result[0].id"/>')" >

						<s:property value="#result[0].projectNumber" />
						
						</td>
	                     <td align="left" onclick="openUrl('programEconomy.action?method=projectInfo&pid=<s:property value="#result[0].id"/>')" ><s:property value="#result[0].projectName" /></td>
						<td align="center" onclick="openUrl('programEconomy.action?method=projectInfo&pid=<s:property value="#result[0].id"/>')"><s:date name="#result[1].designSpeed"
							format="yyyy-MM-dd" /></td>
						<td align="right" onclick="openUrl('programEconomy.action?method=projectInfo&pid=<s:property value="#result[0].id"/>')"><s:property
							value="#result[0].investment" /></td>
						<td align="left" onclick="openUrl('programEconomy.action?method=projectInfo&pid=<s:property value="#result[0].id"/>')"><s:property
							value="#result[0].projectNumberJ" /></td>
						<td align="left" onclick="openUrl('programEconomy.action?method=projectInfo&pid=<s:property value="#result[0].id"/>')"><s:property
							value="#result[0].clientFactory" /></td>
						<td align="left" onclick="openUrl('programEconomy.action?method=projectInfo&pid=<s:property value="#result[0].id"/>')"><s:property value="#result[2]" /></td>
