...
<script language="javascript">
 function doSubmit(){
     document.forms(0).action="/yx/contract/searchReservationReturn.action";
...
<table  border=0   cellpadding="1" cellspacing=1 >
  ...
  <tr>
    <td  align="center" colspan="2">已存在待确认的结算申请<br>无法继续提交</td>
  </tr>
    <tr>
    <td colspan="5"  class="bg_table04">
      <div align="center">
        <input type="button" name="button2" id="button2" value="关  闭" class="button01"  onclick="doSubmit()">
      </div></td>
  </tr>
</table>
</form>
