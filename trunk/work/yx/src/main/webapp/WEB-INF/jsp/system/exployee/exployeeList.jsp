...
location.href="../system/exployee.action"; 
} 
...
function bbb(){
    ...
    if(j==1)
      {  
         location.href="../system/exployee.action?method=enterUpdate&idsss="+checkStr.substring(1);
  ...
  function delChose(){
    ...
    alert(checkStr);
  location.href="../system/exployee.action?method=delExployees&ids="+checkStr.substring(1);
  }
</script>
			...
			<table align="center" border=0 cellpadding=1 cellspacing=1
				...
				<tr class="bg_table03">
					...
					<div align="center"><input type="button" name="SearchBtn2"
						value="　删 除　" class="button01" onClick="javascript:delChose()"><input
