...
<s:form action="hongChongQuery" theme="simple" target="rightFrame">
	<s:hidden name="method" value="showHongChongManager"/>
	...
	<table width="100%"  class="bg_table02" >
		...
		<tr class="bg_table02">
			<td align="right">退票状态：</td>
			<td>
			<s:select name="hongChongState" id="hongChongState" headerKey=" " headerValue=" " list="#@java.util.TreeMap@{'1':'待提交','2':'已确认','3':'待确认','4':'确认退回'}" ></s:select>
			</td>
		</tr>
	       <tr class="bg_table04">
