...
<body>
	...
	<tr>
		...
		<table align="center"  border=0 cellpadding=1 cellspacing=1 width="100%">
			<tr align="center"> 
				<td colspan="4" align="center" class="txt_title01">工程经济组成代码表</td>
			</tr>
			<tr>
	...
	<s:form action="projectEconomyCode" theme="simple">
		<s:hidden name="method" value="updatePEC" />
		<table width="80%">
			<tr>
				<td>工程经济组成代码（流水号）</td><td><s:textfield name="pec.id"  /></td>
			</tr>
			<tr>
				<td>费用名称</td><td><s:textfield name="pec.fareTypeName" /></td>
			</tr>
			<tr>
				<td>最后修改日期</td><s:textfield name="pec.lastupdateTime" /></td>
            </tr>
			<tr>
				<td>最后修改人</td><td><s:textfield name="pec.lastupdateId" /></td>
			</tr>
			<tr align="center">
