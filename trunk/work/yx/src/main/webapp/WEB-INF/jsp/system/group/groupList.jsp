...
location.href="../system/groupCode.action"; 
} 
...
function bbb(){
    ...
    if(j==1)
      {  
         location.href="../system/groupCode.action?method=enterUpdate&idsss="+checkStr.substring(1);
  ...
  location.href="../system/groupCode.action?method=del&ids="+checkStr.substring(1);
  }    
</script>
		...
		<tr>
			...
			<table align="center" border=0 cellpadding="1" cellspacing=1
				...
				<tr align="center">
					...
					<td class="bg_table01">组别代码</td>
					<td class="bg_table01">组别名</td>
