...
<table width="100%" border="1"   bordercolor="#808080" style=" border-collapse: collapse;">
 <tr>
 	...
 	<td align="left" class="info" ><s:property value="cmi.conName"/></td>
 </tr>
  <tr>
...
<table width="100%" border="1"   bordercolor="#808080" style=" border-collapse: collapse;">
 <tr>
 	<td class="info" width="50%">合同总价（含税）：
    <s:property value="cmi.conTaxTamount"/></td>
    <td class="info">合同总价（不含税）：
      <s:property value="cmi.conNoTaxTamount"/></td>
 </tr>
 <s:iterator id="fee" value="mainMoneyList">
 	<tr>
