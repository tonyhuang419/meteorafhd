...
location.href="../system/linkManN.action"; 
} 
...
function bbb(){
    ...
    if(j==1)
      {  
         location.href="../system/linkManN.action?method=enterUpdate&idsss="+checkStr.substring(1);
  ...
  location.href="../system/linkManN.action?method=del&ids="+checkStr.substring(1);
  }    
</script>

</head>
<body>
<s:form action="linkManNQuery">
		...
		<tr>
			...
			<table align="center" border=0 cellpadding="1" cellspacing=1
				...
				<tr align="center">
					...
					<td class="bg_table01">联系人性质代码</td>
