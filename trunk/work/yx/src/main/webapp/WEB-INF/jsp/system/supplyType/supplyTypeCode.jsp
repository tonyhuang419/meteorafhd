...
<script language="javascript">
	function add() 
	{ 
		location.href="../system/supplyTypeCode.action"; 
	} 
	function update(){
    ...
    if(j==1)
      {  
         location.href="../system/supplyTypeCode.action?method=enterUpdate&idsss="+checkStr.substring(1);
  ...
  location.href="../system/supplyTypeCode.action?method=del&ids="+checkStr.substring(1);
  }  
</script>
</head>
<body>
<s:form action="supplyTypeCodeQuery">
	<table width="98%" border="0" cellspacing="1" cellpadding="1" class="bg_white" align="center">
	<tr>
		<td align="center"> 
		<table align="center"  border=0    cellpadding=1 cellspacing=1 width="100%">
			<tr> 
				<td colspan="4" align="center" class="txt_title01">供应商类别代码表</td>
			</tr>
			...
			<tr align="center">
			  <td colspan="4" class="bg_table03" align="center">
					...
					<input type="button" name="update" value=" 修   改" onclick="javascript:update()" class="button01" />
					<input type="button" name="delete"
						value="　删 除　" class="button01" onClick="delChose()"></td>
		...
		<table align="center" border=0  cellpadding="1" cellspacing=1 width="100%">
    		<tr align="center">
    			<td class="bg_table01">选择</td>
      			<td class="bg_table01">供应商类型代码</td>
			...
			<tr align="center">
				...
				<td><s:property value="supplyTypeName" /></td>
