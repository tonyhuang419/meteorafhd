...
<s:form action="corentMouthHarvestProgram" theme="simple" target="rightFrame">
	...
	<table  width="100%" class="bg_table02" >
		...
		<tr class="bg_table02">
			...
			<td align="left">
				<select name="billState">
					...
					<option value="1" <s:if test="#parameters.billState[0] == 1">selected</s:if> >已收款</option>
		...
		<tr style="display:none" class="bg_table02">
		...
		<tr class="bg_table02">
			...
			<td align="left">
				<select name="hasModify">
					<option value="">全部</option>
					<option value="1" <s:if test="#parameters.hasModify[0] == 1">selected</s:if> >已修改</option>
					<option value="0" <s:if test="#parameters.hasModify[0] == 0">selected</s:if> >未修改</option>
				</select>
			</td>
		</tr>
	       <tr class="bg_table04">
