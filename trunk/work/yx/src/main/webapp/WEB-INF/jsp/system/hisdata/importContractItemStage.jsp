...
<body>
<s:form name="fileupload" action ="importHistoryContractGathering" method ="POST" theme="simple" enctype ="multipart/form-data" > 
<div style="color:red">
<s:fielderror/>
</div>
	...
	<tr>
		<td align="center">
			<table align="center" border=0 cellpadding=1 cellspacing=1
				width="100%">
				<tr>
					<td colspan="2" align="left">当前页面：基础管理->历史合同导入->导入开票收款阶段</td>
				</tr>
				<tr class="bg_table02">
