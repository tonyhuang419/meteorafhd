...
function getEmployeeOfDepartment(departmentCode){
		ajaxSetSelectOptions("/yx/jsonData.action?method=doGetEmployeeOfDepartment&departmentCode="+departmentCode,document.outSourceContractWaitSure.expId,"id","name",{value:"",text:"    "});
	}
...
<s:form action="outSourceContractWaitSure" theme="simple" target="content">
