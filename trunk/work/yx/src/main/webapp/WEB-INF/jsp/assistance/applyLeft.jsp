...
<script language="javascript">
	...
	function getEmployeeOfDepartment(departmentCode){
		ajaxSetSelectOptions("<s:url action="jsonData"></s:url>?method=doGetEmployeeOfDepartment&departmentCode="+departmentCode,document.apply.expId,"id","name",{value:"",text:"    "});
	}
...
<iframe
		...
		scrolling="no"></iframe>
<s:form theme="simple" action="apply" target="rightFrame">
<table height="40%" width="100%" border=0 cellpadding=1 cellspacing=0>
		...
		<tr class="bg_table02">
			...
			<td class="bg_table02" align="left"><s:select name="expId"
		...
		<tr class="bg_table02">
			<td align="right" nowrap class="bg_table02"><div align="right">外协合同号：</div></td>
	              <td nowrap>
	              	<s:textfield name="assistanceConNo" id="assistanceConNo" />
	              </td>
		</tr>
		<tr class="bg_table02">
			<td align="center" nowrap class="bg_table02">
			<div align="right">付款申请状态：</div>
			</td>
		...
		<tr class="bg_table02">
			...
			<td nowrap>
			<div align="left">从 <input type="text" id="startDate" name="startDate" size="12" /> <img
				src="/yx/commons/images/calendar.gif"
				onClick="javascript:ShowCalendar('startDate')" align=absMiddle alt="" /></div>
			</td>
		</tr>
		<tr class="bg_table02">
			<td nowrap>至 <input type="text" id="endDate" name="endDate" size="12" /> <img
				src="/yx/commons/images/calendar.gif"
		...
		<tr class="bg_table02">
			...
			<div align="center"><input type="button" value="查    询"
				class="button02" onclick="if(!validate()){document.forms(0).submit();}"/></div>
			</td>
		</tr>
</table>
	</s:form>
