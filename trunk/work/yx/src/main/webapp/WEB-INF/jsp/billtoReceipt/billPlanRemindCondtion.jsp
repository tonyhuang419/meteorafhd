...
<s:form action="showMoonBillQuery" theme="simple" target="rightFrame">
	...
	<table width="100%"  class="bg_table02" >
		...
		<tr class="bg_table02">
			...
			<td align="left">
				<select name="hasApply">
					<option value="">全部</option>
					<option value="1" <s:if test="#parameters.hasApply[0] == 1">selected</s:if> >已申请</option>
					<option value="0" <s:if test="#parameters.hasApply[0] == 0">selected</s:if> >未申请</option>
				</select>
			</td>
		</tr>	
		<tr class="bg_table02">
