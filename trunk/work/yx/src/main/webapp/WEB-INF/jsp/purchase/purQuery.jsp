...
<body>
<s:form action="applyQuery" theme="simple">
<table height="40%"  border=0  cellpadding=1 cellspacing=0>
	...
	<tr>
	     ...
	     <tr class="bg_table02">
	         <td align="center" nowrap class="bg_table02"><div align="right">申购状态：</div></td>
	         <td nowrap>
	         	 <select name="select6">
                 <option>合同未签申购</option>
                 <option>合同已签申购</option>
                 </select>
             </td>
  	</tr>
	<tr class="bg_table02">
		...
		<td nowrap>
		<s:select name="verifyType"  list="typeManageService.getYXTypeManage(1020)"   listKey="typeSmall" listValue="typeName"  
	...
	<tr class="bg_table02">
	   ...
	   <tr class="bg_table02">
			...
			<td nowrap><s:select name="cliName" list="listCli"
				listKey="id" listValue="name" required="true" headerValue="">
			</s:select></td>
  </tr>
  ...
  <tr class="bg_table02">
			...
			<td nowrap>从<input name="sTime" type="text" size="12"
				onfocus="" ><IMG
				
				alt="" src="../../shaoyx/images/button.gif" align=Middle></td>
   </tr>
   <tr class="bg_table02">
			<td nowrap>至<input name="eTime" type="text" size="12"
				onfocus="" ><IMG
				
				alt="" src="../../shaoyx/images/button.gif" align=Middle></td>
		</tr>
                <tr class="bg_table02">
                  <td align="center" nowrap class="bg_table02">申购内容：</td>
                  <td nowrap><input  type="text" name="text" size="15"></td>
                </tr>
            <tr class="bg_table02">
