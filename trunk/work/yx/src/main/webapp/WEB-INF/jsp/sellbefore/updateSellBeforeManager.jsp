...
<div align="left" style="color:#000000">当前页面：售前合同->修改售前合同</div>
<iframe name="errorsFrame" frameborder="0" framespacing="0" height="0" width="100%" scrolling="no"></iframe>
	...
	<s:hidden name="selectExit"></s:hidden>
...
<!--						<s:property id="businessType" value="typeManageService.getYXTypeManage(1002,cbs.businessTypeId).typeName"/>-->
				...
				<tr align="center">
					...
					<s:select name="cbs.dutyDepartmentId" headerKey="" headerValue="--请选择--"
							...
							onchange="getChargeManOfDepartment(this)" listValue="typeName" onclick="cleanMan()" >
						</s:select></td>
				...
				<tr align="center">
					...
					<td class="bg_table02" width="35%" align="left">						
						<s:textfield name="cbs.projectSum" onblur="formatInputNumber(this)"></s:textfield>
					</td>
					<td class="bg_table02" align="right">投标（报价）金额</td>
					<td class="bg_table02" align="left">
						<s:textfield name="cbs.bidSum" onblur="formatInputNumber(this)" ></s:textfield>
				    </td>
				</tr>
				<tr align="center">
					<td class="bg_table02" align="right">中标（合同）金额</td>
					<td class="bg_table02" align="left">
						<s:textfield name="cbs.ownSum" onblur="formatInputNumber(this)" /></td>
					<td class="bg_table02" align="right">投标（报价）日期</td>						
					<td class="bg_table02" align="left">
			  	<div align="left">
			  	<input type="text" id="bidDate" name="cbs.bidDate" value="<s:property value="cbs.bidDate" />"  size="12" />
				...
				<tr align="center">
					...
					<td class="bg_table02" align="left">
			  	<div align="left">
			  	<input type="text" id="projectDate" name="cbs.projectDate" value="<s:property value="cbs.projectDate" />"   size="12" />
			  	<img src="/yx/commons/images/calendar.gif" onClick="javascript:ShowCalendar('projectDate')" align=absMiddle alt=""  />
					...
					<td class="bg_table02" align="left">
			  	<div align="left">
			  	<input type="text" id="estimateProjectDate" value="<s:property value="cbs.estimateProjectDate" />" name="cbs.estimateProjectDate" size="12" />
				...
				<tr align="center">
					...
					<td class="bg_table02" align="left">
			  	<div align="left">
			  	<input type="text" id="estimateSignDate" value="<s:property value="cbs.estimateSignDate" />" name="cbs.estimateSignDate" size="12" />
				...
				<tr align="center">
					...
					<td class="bg_table02" align="left">
						<s:select name="cbs.projectStateSelect" list="#@java.util.TreeMap@{1:'on',2:'off'}" ></s:select>
					</td>
				</tr>
				<tr align="center">
				...
				<tr class="bg_table03" align="center" style="height: 42px">
					...
					<Table style="width: 0%;">
						<tfoot class="bg_table03" style="height: 42px">
							<tr>
								<td align="right" colspan="2"><input type="button" value=" 保 存 " onclick="doSave(0)" class="button01" />
								</td>
								<td align="right" colspan="2"><input type="button" value=" 保存并关闭 " onclick="doSave(1)" class="button01" />
								</td>
								<td colspan="2">
...
<script type="text/javascript">
	...
	function doSave(type){
		if(!validate()){
			...
			if(type == 0){
				document.forms(0).action = "/yx/sellbefore/showSellBefore.action?id=<s:property value="cbs.ID"/>";
				document.forms(0).method.value="selectOrUpdate";
				document.forms(0).submit();
			}
		}
	}
