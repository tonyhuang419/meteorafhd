...
public class ContractMainInfo  implements Serializable{
	...
	@Column(name="beforehand_constate")
	private Boolean beforeHandConState;				//是否需要转为预合同  0 否  1  是
	...
	public Boolean getBeforeHandConState() {
		return beforeHandConState;
	}


	public void setBeforeHandConState(Boolean beforeHandConState) {
		this.beforeHandConState = beforeHandConState;
	}
