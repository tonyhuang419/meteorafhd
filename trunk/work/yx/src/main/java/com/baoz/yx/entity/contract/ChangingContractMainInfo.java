...
public class ChangingContractMainInfo  implements Serializable{
	...
	private Date activeDate; //预合同转正式合同日期
	...
	private String changeType;  //改变类型（1-变更，2-预决算转结算）
	
	@Column(name="CHANGE_CONTRACT_STATE")
	private String changeContractState;//合同变更状态 0，申请保存。1，待确认。2，退回。
	...
	public String getChangeContractState() {
		return changeContractState;
	}

	public void setChangeContractState(String changeContractState) {
		this.changeContractState = changeContractState;
	}
