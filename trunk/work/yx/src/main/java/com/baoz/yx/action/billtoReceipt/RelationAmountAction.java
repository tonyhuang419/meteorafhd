...
public class RelationAmountAction extends DispatchAction implements ServletRequestAware{
	...
	public String relationSuccess()
	{
		...
		service.save(rx);
		contractCommonService.setChangeStatusByInvoiceId(receiptId);
		return SUCCESS;
	}
	...
	public String delRelation()
	{
		...
		RelationAmount amount=(RelationAmount)service.load(RelationAmount.class, relationAId);
		contractCommonService.setChangeStatusByInvoiceId(amount.getInvoiceToReceip());
		service.delete(amount);
