...
public class InitContractBillpro implements java.io.Serializable {
	...
	private BigDecimal initBillAmount;    //原始计划开票金额，基准金额
	
	///////////含税金额
	@Column(name = "init_tax_bill_amount",length = 20,scale = 2)
	private BigDecimal initTaxBillAmount;  //原始计划开票金额（含税）
	///////////
	
	
	@Column(name = "int_rece_amount",length = 20,scale = 2)
	private BigDecimal initReceAmount;  //实际预计收款金额，基准金额
	
	@Column(name = "rint_tax_rece_amount",length = 20,scale = 2)
	private BigDecimal initTaxReceAmount;  //预计收款金额（含税）
	///////////
	...
	public BigDecimal getInitTaxBillAmount() {
		return initTaxBillAmount;
	}

	public void setInitTaxBillAmount(BigDecimal initTaxBillAmount) {
		this.initTaxBillAmount = initTaxBillAmount;
	}
	...
	public BigDecimal getInitReceAmount() {
		return initReceAmount;
	}

	public void setInitReceAmount(BigDecimal initReceAmount) {
		this.initReceAmount = initReceAmount;
	}

	public BigDecimal getInitTaxReceAmount() {
		return initTaxReceAmount;
	}

	public void setInitTaxReceAmount(BigDecimal initTaxReceAmount) {
		this.initTaxReceAmount = initTaxReceAmount;
	}
