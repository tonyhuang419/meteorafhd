...
//开票性质，开票内容 未作关联
@Entity
@Table(name = "yx_changing_real_con_bc_plan")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@org.hibernate.annotations.Entity(selectBeforeUpdate = true, dynamicInsert = true, dynamicUpdate = true)
@Proxy(lazy = false)
public class ChangeRealContractBillandRecePlan implements java.io.Serializable {
...
/////////////////帐龄
	...
	private Long applyBillState;                        //申请单状态   1 确认通过
