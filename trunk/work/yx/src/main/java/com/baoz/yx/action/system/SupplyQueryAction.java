...
public class SupplyQueryAction extends DispatchAction {
	...
	public String doDefault() throws Exception {
		...
		if (supplierType!=null&&!"".equals(supplierType)) {
			str.append(" and si.supplierType= '").append(supplierType).append("'");
		}
		if (eareCode!=null&&!"".equals(eareCode)) {
			str.append(" and si.eareCode= '").append(eareCode).append("'");
		}

		str.append(" order by si.id desc");
		
		info = ParameterUtils.preparePageInfo(info, "supplyQuery");
