...
@Results( {
		@Result(name = "home", value = "/WEB-INF/jsp/contract/contractOkHome.jsp"),
		@Result(name = "contractList", value = "/WEB-INF/jsp/contract/contractOkList.jsp"),
		@Result(name = "contractForm", value = "/WEB-INF/jsp/contract/contractOkSearchForm.jsp") })
public class ContractOKAction extends DispatchAction {
	@Autowired
