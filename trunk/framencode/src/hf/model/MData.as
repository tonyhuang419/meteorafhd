package hf.model
{
    ...
    public class MData extends EventDispatcher
    {
        ...
        private var _parametersData:ParametersData;
        ...
        public function get parametersData() : ParametersData
        {
            if (_parametersData == null)
            {
                _parametersData = new ParametersData();
            }// end if
            return _parametersData;
        }// end function
