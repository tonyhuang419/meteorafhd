        ...
        private function runFn(param1:Object) : void
        {
            ...
            if (param1.hasOwnProperty("errorType"))
            {
                if (param1["errorType"] == "session")
                {
                    ...
                    mainData.runError = Language.L["登录过期，"] + "<a href=\'" + _loc_2 + "\' target=\'_top\'><u><font color=\'#ff6600\'>" + Language.L["点击重新登录"] + "</font></u></a>";
                }
                else
                {
                    mainData.runError = Language.L["初始化错误，"] + "<a href=\'event:reload\'><u><font color=\'#ff6600\'>" + Language.L["点击重试"] + "</font></u></a>";
                }// end else if
            }
            else
            {
