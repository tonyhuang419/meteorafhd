package hf.view.main
{
    ...
    import hf.view.main.window.flower.made.*;
    ...
    public class WindowLayer extends Sprite
    {
        ...
        private var _madeBouquetWin:BaseWindow;
        ...
        private function openShop(param1:Object = null) : void
        {
            if (_shopWindow != null)
            {
        ...
        private function openMadeBouquetWin() : void
        {
            if (_madeBouquetWin != null)
            {
                openWindow(_madeBouquetWin);
                return;
            }// end if
            _madeBouquetWin = new MadeBouquetWin();
            if (stage != null)
            {
                _madeBouquetWin.x = (stage.stageWidth - _madeBouquetWin.width) / 2;
                _madeBouquetWin.y = (stage.stageHeight - _madeBouquetWin.height) / 2;
            }
            else
            {
                _madeBouquetWin.x = 150;
                _madeBouquetWin.y = 100;
            }// end else if
            openWindow(_madeBouquetWin);
            return;
        }// end function
        ...
        private function windowOpen(param1:WindowEvent) : void
        {
            ...
            else if (param1.windowName == "flower")
            {
                openMadeBouquetWin();
            }
            else if (param1.windowName == "shop")
            {
                openShop(param1.windowArgument);
            }
