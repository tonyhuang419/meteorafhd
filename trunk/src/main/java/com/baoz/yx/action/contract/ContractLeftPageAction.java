...
public class ContractLeftPageAction extends DispatchAction{
	...
	public String doDefault() throws Exception {
		...
		str.append("from ContractMainInfo d,YXClientCode yc,Employee emp,ContractOtherInfo o,OrganizationTree org where emp.position = org.id and o.contractMainSid = d.id and d.itemCustomer = yc.id and d.saleMan = emp.id");
		...
		if("1".equals(start)){
			str.append(" and o.perativeReport is not null");
		}
		if("2".equals(start)){
			str.append(" and o.perativeReport is null");
		}
		if("1".equals(physical)){
			str.append(" and o.recivedThing is not null");
		}
		if("2".equals(physical)){
			str.append(" and o.recivedThing is null");
		}
		if("1".equals(completion)){
			str.append(" and o.finallyReport is not null");
		}
		if("2".equals(completion)){
			str.append(" and o.finallyReport is null");
		}
