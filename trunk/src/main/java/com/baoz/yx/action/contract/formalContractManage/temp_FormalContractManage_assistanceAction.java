...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_assistance.jsp")
	 })
public class temp_FormalContractManage_assistanceAction extends DispatchAction{
	@Autowired
