 ...
 *
 */
@Results({@Result(name="home",value="/WEB-INF/jsp/contract/contractItemHome.jsp"),@Result(name="left",value="/WEB-INF/jsp/contract/contractItemLeft.jsp")})
public class ContractItemWriteHomeAction extends DispatchAction{
	@Autowired
