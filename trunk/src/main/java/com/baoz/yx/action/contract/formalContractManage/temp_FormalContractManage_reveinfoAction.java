...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_reveinfo.jsp")
	 })
public class temp_FormalContractManage_reveinfoAction extends DispatchAction{
	@Autowired
