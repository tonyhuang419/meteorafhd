...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_rcplan.jsp")
	 })
public class temp_FormalContractManage_rcplanAction extends DispatchAction{
	@Autowired
