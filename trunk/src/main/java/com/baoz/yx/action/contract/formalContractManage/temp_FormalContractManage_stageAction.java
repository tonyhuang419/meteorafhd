...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_stage.jsp")
	 })
public class temp_FormalContractManage_stageAction extends DispatchAction{
	@Autowired
