...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_ownprod.jsp")
	 })
public class temp_FormalContractManage_ownprodAction extends DispatchAction{
	@Autowired
