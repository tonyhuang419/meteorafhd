...
public class UserService implements IUserService {
	...
	public OrganizationTree getDepartment(Employee user) {
		...
		String departmentCode = postion.getOrganizationCode().substring(0,2);
		OrganizationTree department = (OrganizationTree) commonDao.uniqueResult("from OrganizationTree o where o.organizationCode = ?", departmentCode);
		return department;
	}
