...
<script language="javascript">
	fuction aaa(){
		location.href("../assistance/assistance.action?method=doTicket&id=<s:property value="#parameters.id"/>");
	}
</script>
...
<TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
  ...
  <td class="bg_table02"> <div align="center">
    <input type="submit" name="SearchBtn" value="确认关联" class="button01" onClick="aaa();">　
