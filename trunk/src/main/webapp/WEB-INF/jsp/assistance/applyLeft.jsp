...
<script language="javascript">
	...
	function getClientOfEmployee(employeeId){
		ajaxSetSelectOptions("<s:url action="jsonData"></s:url>?method=doGetClientOfEmployee&employeeId="+employeeId,document.apply.clientSelectId,"id","name",{value:"",text:"    "});
	}
</script>
</head>
<style>
...
<tr>
	      ...
	      <tr class="bg_table02">
	            ...
	            <tr class="bg_table02">
                  <td align="center" nowrap class="bg_table02"><div align="right">付款申请状态：</div></td>
