...
<body>
	...
	<s:form action="supplyTypeCode" theme="simple">
		<s:hidden name="method" value="updateSTC" />
		<table width="80%">
			<tr>
				<td>供应商类别代码表</td><td><s:textfield name="stc.id"  /></td>
			</tr>
			<tr>
				<td>供应商类别</td><td><s:textfield name="stc.fareTypeName" /></td>
			</tr>
			<tr>
				<td>最后修改日期</td><s:textfield name="stc.lastupdateTime" /></td>
            </tr>
			<tr>
				<td>最后修改人</td><td><s:textfield name="stc.lastupdateId" /></td>
			</tr>
			<tr align="center">
