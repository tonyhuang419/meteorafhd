...
location.href="../system/businessType.action"; 
} 
...
function bbb(){
    ...
    if(j==1)
      {  
         location.href="../system/businessType.action?method=enterUpdate&idsss="+checkStr.substring(1);
  ...
  location.href="../system/businessType.action?method=del&ids="+checkStr.substring(1);
  }    
</script>
		...
		<tr>
			...
			<table align="center" border=0 cellpadding="1" cellspacing=1
				...
				<tr align="center">
					...
					<td class="bg_table01">行业类型代码</td>
					<td class="bg_table01">行业类型名</td>
				...
				<s:iterator value="info.result">
					<tr align="center">
						...
						<td><s:date name="updateBy" format="yyyy-MM-dd" /></td>
						<td><s:property value="byId" /></td>
					</tr>
				</s:iterator>
			</table>
