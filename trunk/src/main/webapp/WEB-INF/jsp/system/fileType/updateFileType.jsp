...
<body>
	...
	<s:form action="fileType" theme="simple">
		<s:hidden name="method" value="updateFT" />
		<table width="80%">
			<tr>
				<td>文件类型代码</td><td><s:textfield name="ft.id"  /></td>
			</tr>
			<tr>
				<td>文件类型名称</td><td><s:textfield name="ft.fileTypeName" /></td>
			</tr>
			<tr>
				<td>最后修改日期</td><td><s:textfield name="ft.lastupdateTime" /></td>
            </tr>
			<tr>
				<td>最后修改人</td><td><s:textfield name="ft.lastupdateId" /></td>
			</tr>
			<tr align="center">
