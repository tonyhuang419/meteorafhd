...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="300" id="td1" style="display:block"><iframe src="contract/contractItemWriteHome.action?method=leftFram" width="100%" id="leftframe" frameborder="0" height="100%" style="display:block"></iframe></td>
    ...
    <td width="*"><iframe src="contract/contractItemManager.action" width="100%" id="rightiframe" frameborder="0" height="100%" name="content"></iframe></td>
  </tr>
</table>
</body>
</html>
