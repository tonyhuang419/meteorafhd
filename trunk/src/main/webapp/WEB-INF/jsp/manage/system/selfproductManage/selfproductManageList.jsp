...
<script language="javascript"> 
	...
	function openUrl(url){
		window.open(url,'','menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=1,resizable=1,height=280,width=600');
	}
</script>
<s:form name="selfproductManage" action="selectSelfProduct" theme="simple">
	<table width="100%" border="0" cellspacing="1" cellpadding="1" class="bg_white" align="center">
		<tr>
			<td>当前页面:基础管理->自有产品管理</td>
		</tr>
		<tr>
			<td>
...
<!--					<td width="13%" class="bg_table01" align="left" nowrap>产品代码</td>-->
					<td width="18%" class="bg_table01" align="left" nowrap>产品登记名称</td>
					<td width="14%" class="bg_table01" align="left" nowrap>证书标号</td>
					<td width="14%" class="bg_table01" align="left" nowrap>登记日期</td>
					<td width="14%" class="bg_table01" align="left" nowrap>有效期</td>
				</tr>
				<s:iterator value="info.result" status="status">
					<tr align="center">
						<td><input type="checkbox" name="ids" value="<s:property value='id'/>"/></td>
<!--						<td align="left" nowrap><s:property value="pid" /></td>-->
						<td align="left" nowrap><s:property value="registerName" /></td>
						<td align="left" nowrap><s:property value="certificateNum" /></td>
						<td align="left" nowrap><s:date name="registerDate" format="yyyy-MM-dd" /></td>
						<td align="left" nowrap><s:date name="validateTime" format="yyyy-MM-dd" /></td>
					</tr>
				</s:iterator>
			</table>
			</td>
