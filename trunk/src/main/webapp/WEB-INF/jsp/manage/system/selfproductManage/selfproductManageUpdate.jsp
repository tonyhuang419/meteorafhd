...
<iframe name="errorsFrame" frameborder="0" framespacing="0" height="0"
	...
	<tr> 
		...
		<table width="94%" border="0" cellspacing="1" cellpadding="1">
			...
			<tr>
			  <td height="3" align="left" >当前页面：自有产品管理-&gt;修改自有产品信息</td>
		  </tr>
		...
		<table width="94%" border="0" cellspacing="1" cellpadding="1">
			<tr align="center">
			  ...
			  <td class="bg_table02" align="left"><s:textfield name="sp.registerName"></s:textfield></td>
			...
			<tr align="center">      
			  ...
			  <td class="bg_table02" align="left"><div align="left"><input type="text" id="bidDate1"
						name="sp.registerDate" value="<s:date name="sp.registerDate" format="yyyy-MM-dd" />" readonly="readonly"
			  ...
			  <td class="bg_table02" align="left"><div align="left"><input type="text" id="bidDate2"
						name="sp.validateTime" value="<s:date name="sp.validateTime" format="yyyy-MM-dd" />" readonly="readonly"
						onClick="javascript:ShowCalendar(this.id)" size="12" /> <img
						src="/yx/commons/images/calendar.gif"
			...
			<tr class="bg_table03" align="center" style="height:42px">
				...
				<Table style="width:0%;100%">
					<tfoot class="bg_table03" style="height:42px">
						...
						onClick="window.close();" value="关   闭"></tr>
					</tfoot>
				</Table>				</td>
			</tr>
		</table>
