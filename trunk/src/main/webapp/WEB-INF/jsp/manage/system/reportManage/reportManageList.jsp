		...
		<tr>
			...
			<table align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
				<tr align="center">
					...
					<td width="9%" class="bg_table01" align="left" nowrap>编号</td>
					<td width="30%" class="bg_table01" align="left" nowrap>公告内容</td>
					<td width="14%" class="bg_table01" align="left" nowrap>公告天数</td>
					<td width="14%" class="bg_table01" align="left" nowrap>发布时间</td>
					<td width="14%" class="bg_table01" align="left" nowrap>发布人</td>
				</tr>
...
<script language="javascript"> 
	...
	function add(){
	   openUrl("<s:url action="gonggao"></s:url>");
	} 
	...
	function edit(){
	   ...
	   openUrl("<s:url action="gonggao"><s:param name="method">enterUpdate</s:param></s:url>&id="+checkedId);
   } 
	...
	function openUrl(url){
		window.open(url,'','menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=1,resizable=1,height=260,width=630');
	}
