package gcodeJam.multBaseHappiness;
...
public class MyHappiness {
	...
	{
		Scanner in = new Scanner(new File("src/main/java/gcodeJam/multi_base_happiness/test.in"));
		PrintWriter fout = new PrintWriter(new FileWriter("src/main/java/gcodeJam/multi_base_happiness/test.out"));
		int T,K;
