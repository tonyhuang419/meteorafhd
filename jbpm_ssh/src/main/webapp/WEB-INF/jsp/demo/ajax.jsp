...
function doGetFeedBack(obj){
	var jsonRequest = new Request.JSON({async:false,url:'/jbpm_ssh/demo/ajax.action?method=doAjax&info='+obj.value,
...
function doGetFeedBackArray(obj){
	var jsonRequest = new Request.JSON({async:false,url:'/jbpm_ssh/demo/ajax.action?method=doAjaxArray&info='+obj.value,
		onComplete: function(jsonObj){
		 if(jsonObj!=null && jsonObj.jsonData !=null ){
			var infoArray=""; 
