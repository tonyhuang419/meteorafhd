...
function popwin()
{
	window.open('yx/statistics/billStat.action?method=popQuery','newwindow','menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=1,resizable=1,height=500,width=600');
...
<s:form action="billStat" theme="simple">
	...
	<s:if test="info!=null">
		<table align="center" border=1 cellpadding="1" cellspacing=1
			...
			<s:set name="subRealArriveAmount" value="0.00"></s:set>
			<s:iterator value="info.result" id="bill">
				<tr class="bg_table02">
					...
					<td><a href="#" onclick="openCon('<s:property value="#bill[8].longValue()"/>')" ><s:property value="#bill[3]" /></a></td>
				...
				<s:set name="subRealArriveAmount" value="#subRealArriveAmount + #bill[9]"></s:set>
			...
			<tr class="bg_table02">
					...
					<td align="right"><s:property value="#subRealArriveAmount" /></td>
			</tr>
			<tr class="bg_table02">
					<td></td>
					<td></td>
					...
					<td align="right"><s:property value="totalRealArriveAmount" /></td>
			</tr>
			<tr class="bg_table04">		
