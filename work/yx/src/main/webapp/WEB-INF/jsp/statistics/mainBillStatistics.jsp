...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="310" id="td1" style="display:block;"><iframe src="/yx/statistics/billStat.action?method=leftQuery" scrolling="auto" width="100%" id="leftFrame" name="leftFrame" frameborder="0" height="100%" style="display:block"></iframe></td>
...
onMouseOver="this.bgColor='#BBBBFF'; "  onMouseOut="this.bgColor='lightblue';" bgcolor="lightblue"> 
    ...
    <td width="*"><iframe src="/yx/statistics/billStat.action?method=showMainInfo" width="100%" id="rightFrame" scrolling="auto" frameborder="0" height="100%" name="rightFrame"></iframe></td>
  </tr>
</table>
</body>
</html>
