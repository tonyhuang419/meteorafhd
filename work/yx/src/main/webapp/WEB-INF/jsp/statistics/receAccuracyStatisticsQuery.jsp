...
<script type="text/javascript">
	function getEmployeeOfDepartment(departmentCode){
		ajaxSetSelectOptions("<s:url includeParams="none" action="jsonData"></s:url>?method=doGetEmployeeOfDepartmentSimple&departmentCode="+departmentCode,document.recePrecisionStat.saleMan,"id","name",{value:"",text:"    "});
	}
	...
	{
		var departmentCode=document.recePrecisionStat.groupId.value;
		ajaxSetSelectOptions("<s:url includeParams="none" action="jsonData"></s:url>?method=doGetEmployeeOfDepartmentSimple&departmentCode="+departmentCode,document.recePrecisionStat.saleMan,"id","name",{defaultAsync:false,value:"",text:"    "});
		var selectNode=document.recePrecisionStat.saleMan.options;
...
<body>
<s:form action="recePrecisionStat" theme="simple" target="main_view">
...
<s:hidden name="resetCondition" value="true"/>
	...
	<table align="center" border=0 cellpadding=1 cellspacing=1 width="100%" class="bg_table02">
		<tr class="bg_table02">
	     ...
	     <tr>
		<td align="right">计划收款日期：</td>
			<td>
				<s:select name="yearSel" onchange="monthChange()" id="yearSel" list="yearMap"></s:select>
				 年 
				<s:select name="monthSel" list="{'01','02','03','04','05','06','07','08','09','10','11','12'}" id="monthSel" onchange="monthChange()" ></s:select> 月
			</td>
		</tr>
	       <tr class="bg_table01">
