...
<html>
<head>
<title>开票计划变更统计主页面</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<%@ include file="/commons/jsp/meta.jsp"%>
<script type="text/javascript">
function popwin()
{
	window.open('yx/statistics/billProjectChangeStat.action?method=popQuery','newwindow','menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=1,resizable=1,height=500,width=600');
	//window.open('yx/statistics/billStat.action?method=popQuery');
}
function showChangeDetials(opValue){
	window.open('yx/statistics/billProjectChangeStat.action?method=popShowDetails&planId='+opValue,'newwindow','menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=1,resizable=1,height=500,width=1000');
}
function exportInfo(){
	...
	<s:if test="info!=null">
		<table align="center" border=1 cellpadding="1" cellspacing=1
			...
			<tr class="bg_table01">
				...
				<td align="center" nowrap="nowrap">合同号</td>
				<td align="center" nowrap="nowrap">项目号</td>
				<td align="center" nowrap="nowrap">合同名称</td>
				<td align="center" nowrap="nowrap">客户名称</td>
				<td align="center" nowrap="nowrap">新开票日期</td>
				<td align="center" nowrap="nowrap">原始开票日期</td>
				<td align="center" nowrap="nowrap">预计开票金额</td>
				<td align="center" nowrap="nowrap">变更数</td>
				<td align="center" nowrap="nowrap">合同阶段</td>
				<td align="center" nowrap="nowrap">变更日期</td>
			</tr>
			...
			<s:iterator value="info.result" id="bill">
				...
				<s:set name="subTotalPreBill" value="#subTotalPreBill+#bill[7]"></s:set>
			</s:iterator>
			<tr class="bg_table02">
					<td></td>
					<td></td>
			...
			<tr class="bg_table04">
				<td colspan="11" align="center"><baozi:pages value="info"
					beanName="info" formName="billProjectChangeStat" /></td>
			</tr>
		</table>
	</s:if>
</s:form>
