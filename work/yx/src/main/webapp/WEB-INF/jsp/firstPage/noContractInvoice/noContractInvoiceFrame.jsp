...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="250" id="td1" style="display:block"><iframe src="/yx/firstPage/noContractSignInvoice.action" 
    ...
    <td width="*"><iframe src="/yx/firstPage/noContractSignInvoice.action?method=right&resetCondition=true" 
