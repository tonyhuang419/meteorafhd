...
function getEmployeeOfDepartment(departmentCode){
		ajaxSetSelectOptions("/yx/jsonData.action?method=doGetEmployeeOfDepartment&departmentCode="+departmentCode,document.outSourcePayWaitSure.expId,"id","name",{value:"",text:"    "});
	}
...
<s:form action="outSourcePayWaitSure" theme="simple" target="content">
