...
<s:hidden name="clietId"/>
 <div id="showtishi" align="left" style="color: #FF0000" >
            ...
            <ul class="bg_table02">
              ...
              <li id="tag2"><a href="#" onclick="javascript:if(!validate()){setNum(2);document.formalContractModify.submit();}"><span id="tag02">开票收款阶段</span></a></li>
              <li id="tag3"><a href="#" onclick="javascript:if(!validate()){setNum(3);document.formalContractModify.submit();}"><span id="tag03">项目信息</span></a></li>
