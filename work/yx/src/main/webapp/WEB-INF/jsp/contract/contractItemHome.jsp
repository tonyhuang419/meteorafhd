...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="340" id="td1" style="display:block"><iframe src="contract/contractItemWriteHome.action?method=leftFram" 
    ...
    <td width="*"><iframe src="contract/contractItemManager.action<s:if test="#parameters.projectNoState != null">?projectNoState=<s:property value="#parameters.projectNoState"/></s:if>" width="100%" id="rightiframe" frameborder="0" height="100%" name="content"></iframe></td>
  </tr>
</table>
</body>
</html>
