...
<body leftmargin="0">
<s:form name="searchContractOkList" action="contractItemManager" target="content" theme="simple">
<s:hidden name="itemNo" value="1"></s:hidden>
    ...
    <td colspan="2" align="right" class="bg_table01"  height="0.5"><img src="./../images/temp.gif" width="1" height="1"></td>
      ...
      <tr>
        <td width="38%" class="bg_table02"><div align="right">小组：</div></td>
  <td class="bg_table02"><label></label>
      ...
      <tr>
        ...
        <td width="62%" class="bg_table02"> <s:select name="expId" onchange="getClientOfEmployee(this.value)" list="listExp" listKey="id" listValue="name" required="true" headerValue="" emptyOption="true"></s:select></td>
      </tr>
      <tr>
