...
<iframe name="errorsFrame" frameborder="0" framespacing="0" height="0"
	...
	<s:hidden name="sp.id" />
	<s:hidden name="registerNameHidden" />
	
	 <div align="left" style="color:#000000">当前页面：自有产品管理-&gt;修改自有产品信息</div>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			...
			<tr align="center">
			  ...
			  <td class="bg_table02" align="left"><s:textfield name="sp.registerName" onblur="isExist('/yx/system/selfProduction.action','isExist',$('sp.registerName').value);"></s:textfield></td>
			  <td class="bg_table02" align="right"><font color="red">* </font>证书标号：</td>
			  <td class="bg_table02" align="left"><s:textfield name="sp.certificateNum"></s:textfield></td>
		  </tr>
			<tr align="center">      
			  <td class="bg_table02" align="right"><font color="red">* </font>登记日期：</td>
			  <td class="bg_table02" align="left"><div align="left"><input type="text" id="bidDate1"
						name="sp.registerDate" value="<s:date name="sp.registerDate" format="yyyy-MM-dd" />" 
						 size="12" /> <img
			  ...
			  <td class="bg_table02" align="left"><div align="left"><input type="text" id="bidDate2"
						name="sp.validateTime" value="<s:date name="sp.validateTime" format="yyyy-MM-dd" />" 
						 size="12" /> <img
						src="/yx/commons/images/calendar.gif"
...
if($('sp.registerName').value!=$('registerNameHidden').value){
