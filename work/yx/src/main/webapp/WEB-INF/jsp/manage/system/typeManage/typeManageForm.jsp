...
<s:form action="typeManage.action" theme="simple">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1" class="bg_white" align="center">
					...
					<td align="right" class="bg_table02"><s:iterator value="typeManageList" status="status">
						...
						<table align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
							...
							<tr align="center">
								...
								<td class="bg_table02" align="left"><input type="text" name="otherInfo" value="<s:property value='typeManageList[#status.index].info'/>" /></td>
							</tr>
							<tr align="center">
				            ...
				            <tr align="center">
								<td class="bg_table02" align="right">层次代码</td>
								<td class="bg_table02" align="left"><input size="5" type="text" name="treePath" value="<s:property value='typeManageList[#status.index].treePath'/>" /></td>
							</tr>
						</table>
						<br>
						<br>
		...
		<tr>
			...
			</s:else><input type="button" value="返    回" class="button02" onclick="javascript:window.location='yx/system/typeManageQuery.action'"/></td>
		</tr>
	</table>
</s:form>
...
if($('ids')!=null){
if($('orgTypeBig').value!=$('typeBig')||$('orgTypeSmall')!=$('typeSmall')){
