...
<s:form action="chargeman" theme="simple">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1"
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1">
				<tr>
					<td height="3" align="left">当前页面：部门负责人管理-&gt;修改负责人</td>
				</tr>
				<tr>
...
function check(){	
	if(!validate()){
	    document.forms(0).method.value = "updatePro";
...
function addDepartment(){
	document.forms(0).method.value = "updateDepartment";
	document.forms(0).submit();
}
function delDepartment(departmentCode){
	document.forms(0).deleteDepartmentid.value = departmentCode;
    document.forms(0).method.value = "updateDelDepartment";
	document.forms(0).submit();
}
</script>
