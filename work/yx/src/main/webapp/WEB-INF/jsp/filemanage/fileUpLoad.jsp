...
<table width="100%" border="0" cellspacing="1" cellpadding="1"
	...
	<tr>
		...
		<table align="center" border=0 cellpadding=1 cellspacing=1
			...
			<tr class="bg_table02">
				<td align="right"><font color="red">* </font>所属客户：</td>
				<td class="bg_table02"  align="left" >
					...
					<s:select name="clientcode" list="clientList" cssStyle="margin-left:-150px;width:168px;" listKey="id" listValue="name" onchange="clientChange(this)" emptyOption="true"></s:select>
					</span>
					...
					<s:hidden name="fm.clientcode" id="clientId"></s:hidden>
					</td>
			</tr>
			<tr class="bg_table02">
				<td align="right"><font color="red">* </font>文件名：</td>
				<td align="left"><s:textfield size="30" maxlength="50" name="fm.filename"/>
				</td>
			</tr>
			<tr class="bg_table02">
...
function validate(){
       ...
       with(fileUpLoad){  
       ev2.test("notblank","所属客户不能为空",$('clientId').value); 
