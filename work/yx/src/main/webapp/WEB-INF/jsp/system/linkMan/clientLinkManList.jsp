...
<s:hidden name="resetCondition" value="true"/>
	<table width="100%" border="0" cellspacing="1" cellpadding="1"
		...
		<tr>
			...
			<tr><td colspan="9" class="bg_table01" height="1"><img src="../../images/temp.gif" width="1" height="3"></td>
			</tr>
			<tr class="bg_table03">
             <td align="left" nowrap class="bg_table03"><align="right">所属客户： <s:textfield name="clientName" size="15"></s:textfield> <input class="button01" onclick="queryByClient()" type="button" name="Input" value="查  询"  /></td>
					...
					<input				
						...
						<input type="button" name="SearchBtn2"
						value=" 修 改" class="button01" onClick="javascript:bbb()" >
						<input
			...
			<table align="center" border=1 cellpadding="1" cellspacing=1
				...
				<s:iterator value="info.result" id="linkman">
					<tr align="center"  onMouseOver="this.bgColor='#BBBBFF'; "
						...
						<td align="left"><s:property value="#linkman[0].name" /></td>
						<td align="left"><s:property value="#linkman[1]"/></td> 
						<td align="left"><s:property value="#linkman[0].callPhone" /></td>
						<td align="left"><s:property value="#linkman[0].phone" /></td>
						<td align="left"><s:property value="typeManageService.getYXTypeManage(1003L,#linkman[0].natureId).typeName"/></td> 
					    <td align="left"><s:property value="#linkman[0].address" /></td>
						<td align="center"><s:property value="#linkman[0].updateBy" /></td>
						<td align="left"><s:property value="#linkman[2].name" /></td>
					</tr>
				</s:iterator>
			</table>
