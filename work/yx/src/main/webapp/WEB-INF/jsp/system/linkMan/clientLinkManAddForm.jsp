...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="bg_white" align="center">
	<tr> 
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr align="center">
			  <td  width="25%" class="bg_table02" align="right"><font color="red">* </font>联系人姓名：</td>
			  <td  width="25%" class="bg_table02" align="left"><input type="text" name="cc.name" size="20" /></td>
			  
			  <td  width="25%" class="bg_table02" align="right">手机：</td>
			  <td  width="25%" class="bg_table02" align="left"><input type="text" name="cc.callPhone" size="20" /></td>
	...
	<tr align="center">
			...
			<tr class="bg_table03" align="center" style="height:42px">
				<td colspan="4"> <div align="center">
					   	<input class="button01" type="button" name="Input" value="保    存"  onclick="check();" />
							<s:if test=" from == 1 ">
                         		<input class="button01" type="submit" value="返    回" 
                         			 onclick="javascript:window.history.go(-1);"></td></tr>	 
                         	</s:if>
                         	<s:else>
                         		<input class="button01" type="submit" value="返    回" 
                         			 onclick="javascript:document.forms(0).action='yx/system/clientLinkManQuery.action?resetCondition=true'"></td></tr>	 
                         	</s:else>
				 </td>				
			</tr>
		</table>
