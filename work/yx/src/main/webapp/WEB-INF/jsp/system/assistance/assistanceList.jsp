...
location.href="../system/assistance.action"; 
} 
...
function bbb(){
    ...
    if(j==1)
      {  
         location.href="../system/assistance.action?method=enterUpdate&idsss="+checkStr.substring(1);
  ...
  location.href="../system/assistance.action?method=del&ids="+checkStr.substring(1);
  }    
</script>

</head>
<body>
<s:form action="groupCodeQuery">
		...
		<tr>
			...
			<table align="center" border=0 cellpadding=1 cellspacing=1
				...
				<tr class="bg_table03">
					...
					<div align="center"><input type="button" name="SearchBtn2"
						value="　删 除　" class="button01" onClick="javascript:delChose()">
						<input
			...
			<table align="center" border=0 cellpadding="1" cellspacing=1
				...
				<tr align="center">
					...
					<td class="bg_table01">开户银行</td>
					<td class="bg_table01">银行帐号</td>
