...
<s:hidden name="method" value="getSelectClientlist"/>
		...
		<tr>
			...
			<table align="center" border=0 cellpadding="1" cellspacing=1
				...
				<tr align="center">
					...
					<td class="bg_table01" width="20%">客户全称</td>
					<td class="bg_table01" width="20%">客户简称</td>
				...
				<s:iterator value="info.result">
					<tr align="center">
						...
						<td><input type="hidden" name="name"
							value="<s:property value="name"/>" style="border: 0px">
