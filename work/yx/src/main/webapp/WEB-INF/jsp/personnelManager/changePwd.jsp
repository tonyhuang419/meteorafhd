...
<s:form action="personnelManager" theme="simple">
	<s:hidden name="method" value="changePwd" />
	...
	<table width="40%" border="0" cellspacing="1" cellpadding="1" class="bg_white" align="center">
		...
		<tr align="center">
			<td  class="bg_table02" align="right">密码:</td>
		...
		<tr>
			...
			<input type="button" name="close" value="返  回" class="button01" onClick="javascript:back();" /></td>
		</tr>
	</table>
