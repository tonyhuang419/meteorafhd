...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="bg_white" align="center" >
	<tr> 
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			<tr>
			  <td height="3" align="left" >当前页面：权限管理->员工新增</td>
		  </tr>
          <tr>
            	<td colspan="4" align="center" class="bg_table01"  height="0.5">
            	<img src="./../images/temp.gif" width="1" height="3"></td>
       	  </tr>
		</table>
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<tr align="center">
			  ...
			  <td width="35%" align="left" nowrap class="bg_table02">
			  	<input type="text" name="per.username" id="tempUserName"  maxlength="10">
			  	<s:hidden name="userName"></s:hidden>
			  </td>
			  <td align="right" nowrap class="bg_table02"><font color="red">* </font>密码：</td>
			  <td align="left" nowrap class="bg_table02"><s:password maxlength="10"  name="password" size="22" />             </td>
		  </tr>
			<tr align="center">
			  <td width="15%" align="right" nowrap class="bg_table02"><font color="red">* </font>工号：</td>
			  <td width="35%" align="left" nowrap class="bg_table02"><s:textfield maxlength="10" cssClass="textinput" name="per.workId" size="20" /></td>
			  <td align="right" nowrap class="bg_table02"><font color="red">* </font>姓名：</td>
			  <td align="left" nowrap class="bg_table02"><s:textfield cssClass="textinput" maxlength="10" name="per.name" size="20"/>             </td>
		  </tr>
			<tr align="center">
				...
				<Table style="width:0%;100%">
					<tfoot class="bg_table03" style="height:42px">
						<tr>
							...
							<input class="button01" type="button" onclick="document.forms(0).isRelationLinkMan.value = 'true';doSave();" name="savePer" value="保存关联客户" >	
