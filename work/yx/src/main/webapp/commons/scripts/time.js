...
var today; 
calendarSign = 0;  //1:表示是show函数出来的每次show时置1 , 每次判断完后归0
...
function ShowCalendar(InputBox)
{
    ...
    DivContent+="<tr>";
    DivContent+="<td style='padding:0px 0px 0px 0px; border-bottom:1px solid #0066FF; background-color:#C7D8FA'>";
    ...
    DivContent+="<td style='border-bottom:1px solid #0066FF; background-color:#C7D8FA; font-weight:bold; font-family:Wingdings 2,Wingdings,Webdings; font-size:16px; padding-top:1px; padding:1px 0px 0px 0px; color:#4477FF; cursor:hand' align='center' title='关闭' onClick='javascript:HiddenCalendar()'>S</td>";
    DivContent+="</tr>";
     
    DivContent+="<tr><td style='padding:0px 0px 0px 0px;' align='center' colspan='2'>";
    DivContent+="<table id='calendar' border='0' width='100%'>";
    
    //星期
    DivContent+="<tr>";
    for (intLoop = 0; intLoop < days.length; intLoop++) 
        DivContent+="<td align='center' style='padding:0px 0px 0px 0px; font-size:12px'>" + days[intLoop] + "</td>"; 
    DivContent+="</tr>";
    ...
    { 
        ...
        for (intDays = 0; intDays < days.length; intDays++) 
            DivContent+="<td onClick='GetDate(\"" + InputBox + "\")' style='padding:0px 0px 0px 0px; cursor:hand; border-right:1px solid #BBBBBB; border-bottom:1px solid #BBBBBB; color:#215DC6; font-family:Verdana; font-size:12px' align='center'></td>"; 
        DivContent+="</tr>"; 
    } 
    DivContent+="</table>";
    ...
    DivContent+="<tr><td align='center' style='padding:0px 0px 0px 0px; font-family:Verdana; font-size:12px' colspan='2'>";
