...
public class ContractProjectInputQueryAction extends DispatchAction {
	@Autowired
	...
	public String doDefault() throws Exception {
		...
		info = queryService.listQueryResult(
				...
				"i.contractMainInfo=m.conMainInfoSid and i.itemResDept=t.typeSmall and t.typeBig=1018 and i.conItemCostSure in (1,2,3,4)" +
