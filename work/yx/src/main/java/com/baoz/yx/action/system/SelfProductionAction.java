...
public class SelfProductionAction extends DispatchAction implements ServletRequestAware  {
	...
	private String registerNameHidden;
...
//		logger.info("=============sssstate");
		...
		this.sp = o;
		registerNameHidden=o.getRegisterName();
...
//		Date d = new Date();
	...
	public String isExist(){
		logger.info("isExist");
		SelfProduction spTemp=(SelfProduction) service.uniqueResult("from SelfProduction sp where sp.is_active=1 and sp.registerName = ?", sp.getRegisterName());

		logger.info(spTemp);
		if(spTemp!=null) this.renderText("1");
	...
	public String getRegisterNameHidden() {
		return registerNameHidden;
	}


	public void setRegisterNameHidden(String registerNameHidden) {
		this.registerNameHidden = registerNameHidden;
	}
