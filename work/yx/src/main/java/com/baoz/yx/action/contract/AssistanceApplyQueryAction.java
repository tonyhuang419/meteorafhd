...
import com.baoz.yx.tools.SeeBeanFields;
...
public class AssistanceApplyQueryAction extends DispatchAction {
	...
	public String doDefault() throws Exception {
		...
		mainContract = service.list(" select c.conId,c.conName,emp.name,c.conMainInfoSid,c.conCustomer  from ContractMainInfo c,Employee emp where c.saleMan = emp.id and c.conMainInfoSid = " + mainId);
	...
	public String saveAContract()
	{
		...
		a.setAssistanceId(codeGenerateService.generateAssistanceCode(contractProjectId, new Date(), contractCustomerID));
//		a.setAssistanceId("...");
