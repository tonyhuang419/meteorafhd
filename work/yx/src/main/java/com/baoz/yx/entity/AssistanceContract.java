...
public class AssistanceContract extends PriEntity implements Serializable {
	private static final long serialVersionUID = 7692497303834446232L;
	@Id
	...
	private String 				assistanceContractType;			//外协合同状态(0-草稿；1-提交待确认；2-确认通过；3-确认退回；4-已关闭)
	@Column(name = "TICKET_MONEY", length = 20)
	private Double 				ticketMoney;					//开票金额
	...
	@Column(name = "con_item_main_info_sid")
	private Long conItemMainInfoSid;							//项目id
	@Column(name = "fk_employee_id")
	private Long employeeId;                                    //销售员id
	@Column(name = "return_reason")
	private String returnReason;                                    //退回理由
	
	@Column(name = "hasPayAmount")
	private Double hasPayAmount;   ////已支付金额
	
	@Column(name ="receiptAmount")
	private Double receiptAmount;  //开收据金额
	...
	public Long getConItemMainInfoSid() {
		return conItemMainInfoSid;
	}
	public void setConItemMainInfoSid(Long conItemMainInfoSid) {
		this.conItemMainInfoSid = conItemMainInfoSid;
	}
