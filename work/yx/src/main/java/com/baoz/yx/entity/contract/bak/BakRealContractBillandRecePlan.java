...
@Entity
@Table(name = "yx_bak_real_con_bc_plan")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@org.hibernate.annotations.Entity(selectBeforeUpdate = true, dynamicInsert = true, dynamicUpdate = true)
@Proxy(lazy = false)
public class BakRealContractBillandRecePlan implements Serializable{

	private static final long serialVersionUID = 3324631844641795189L;

	@Id
	@TableGenerator(name="sid",table="sysid",pkColumnName="id",valueColumnName="tableid",pkColumnValue="BakRealContractBillandRecePlan",allocationSize=1)
