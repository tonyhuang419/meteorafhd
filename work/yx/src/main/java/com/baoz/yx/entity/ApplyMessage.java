...
public class ApplyMessage extends PriEntity implements Serializable {
	...
	private String applyType; // 申购类型（1－工程类；2－集成类）
	...
	@Column(name = "ITEM_MAIN_ID", length = 20)
	private Long itemMainId;  // 项目主体系统号 
	...
	public Long getItemMainId() {
		return itemMainId;
	}
	public void setItemMainId(Long itemMainId) {
