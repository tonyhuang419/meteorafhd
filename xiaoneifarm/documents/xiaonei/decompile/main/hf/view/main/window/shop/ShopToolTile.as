    ...
    public class ShopToolTile extends Sprite
    {
        ...
        private function tileChildClick(param1:ViewEvent) : void
        {
            ...
            if (_loc_2["tId"] != 909090)
            {
                ...
                _loc_3.windowName = "ShopToolWindow";
                _loc_3.windowArgument = param1.data;
                ViewControl.getInstance().dispatchEvent(_loc_3);
            }
            else
            {
                _loc_4 = MData.getInstance().mainData;
                if (!_loc_4.hasEventListener("DOG_FOOD_FEED_IN_SHOP"))
                {
                    _loc_4.addEventListener(MainData.DOG_FOOD_FEED_IN_SHOP, openFoodWinInShopFn);
                }// end if
