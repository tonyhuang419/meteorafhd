...
public class CommonsUtils {
	...
	private int gg(int param1,int param2,int param3,int param4,int param5, int param6,int param7){
		return transform(this.g(param1, param2, param3), param1, param2, param3, param4, param5, param6, param7);
	}
	...
	private  int ff(int param1, int param2, int param3, int param4 ,int param5, int param6, int param7) {
		return transform(this.f(param1, param2, param3), param1, param2, param3, param4, param5, param6, param7);
	}
	...
	private int hh(int param1, int param2, int param3, int param4, int param5, int param6, int param7){
		return transform(this.h(param1, param2, param3), param1, param2, param3, param4, param5, param6, param7);
	}
	...
	private int ii(int param1, int param2, int param3, int param4, int param5, int param6, int param7){
		return transform(this.i(param1, param2, param3), param1, param2, param3, param4, param5, param6, param7);
	}

	private static int[] createBlocks(String str){
		int[] _loc_2 = new int[10000];
