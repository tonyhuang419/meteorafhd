...
def ancestors(genealogy, person):
    if person in genealogy:
        return genealogy[person] +  ancestors ( genealogy  ,genealogy[person][0] ) \
            +  ancestors ( genealogy  ,genealogy[person][1] ) 
    return []

#     return genealogy[person] +  ancestors ( genealogy  ,genealogy[person][0] ) \
#         +  ancestors ( genealogy  ,genealogy[person][1] )  if person in genealogy else []
