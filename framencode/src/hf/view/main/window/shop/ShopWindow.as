package hf.view.main.window.shop
{
    ...
    public class ShopWindow extends BaseWindow
    {
        ...
        override public function init() : void
        {
            ...
            addTab();
            if (data != null && data.hasOwnProperty("selectTab"))
            {
        ...
        {
            super.data = param1;
            if (param1.hasOwnProperty("selectTab"))
            {
                selectTab(param1["selectTab"]);
            }// end if
            return;
        }// end function
        ...
        {
            var _loc_2:Object;
            if (mainData.hasDog && Version.value != Version.FACEBOOK)
            {
                _loc_2 = {depict:"添加狗粮", effect:"0", FBPrice:"0", price:"5", tId:909090, timeLimit:"0", tName:"狗粮", type:3};
                mainData.toolsInfo.push(_loc_2);
            }// end if
