package hf.view.farm.farmAnimal
{
    ...
    public class FarmAnimal extends Sprite
    {
        ...
        private function removeDizzyDog() : void
        {
            var _loc_1:DizzyDog;
            if (getChildByName("dizzyDog") != null)
            {
                _loc_1 = getChildByName("dizzyDog") as DizzyDog;
                removeChild(_loc_1);
            }// end if
            return;
        }// end function
        ...
        {
            var _loc_2:DogFoodViewWindow;
            var _loc_3:DogFoodWindow;
            if (MData.getInstance().mainData.me)
            {
                if (Version.value == Version.FACEBOOK)
                {
                    _loc_2 = new DogFoodViewWindow();
                    WControl.open(_loc_2);
                }
                else
                {
                    _loc_3 = new DogFoodWindow();
