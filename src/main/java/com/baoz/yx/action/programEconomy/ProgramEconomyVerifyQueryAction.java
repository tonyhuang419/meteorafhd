...
public class ProgramEconomyVerifyQueryAction extends DispatchAction {
	...
	public String doDefault() throws Exception {
		...
		String hqlms = ("select pe,s,e.name ,orgTree from YXOProgramEconomy pe, YXOSectionInfo s ,Employee e ,OrganizationTree orgTree where"
				+ " pe = s.economy  and e.id = pe.exployeeId and pe.state=6 and pe.is_active=1 "
				+ "and s.is_active=1 and e.position=orgTree.id");
		String VerifyHql = systemService.getSqlA(hqlms, money1, money2, str3,
