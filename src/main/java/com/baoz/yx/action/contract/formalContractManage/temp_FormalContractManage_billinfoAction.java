...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_billinfo.jsp")
	 })
public class temp_FormalContractManage_billinfoAction extends DispatchAction{
	@Autowired
