...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_item.jsp")
	 })
public class temp_FormalContractManage_itemAction extends DispatchAction{
	@Autowired
