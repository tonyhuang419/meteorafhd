...
@Results( {
	@Result(name = "success", value = "/WEB-INF/jsp/contract/formalContractManage/temp_formalContractManage_purchase.jsp")
	 })
public class temp_FormalContractManage_purchareAction extends DispatchAction{
	@Autowired
