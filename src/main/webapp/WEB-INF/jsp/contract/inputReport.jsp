...
<body leftmargin="0">
<s:form action="contractSmall" theme="simple">
<s:hidden name="num" value="1"></s:hidden>
...
<table width="100%" border=0   cellpadding="1" cellspacing=1 >
  ...
  <tr>
    <td colspan="2"  class="bg_table02"><div align="center"><strong>开工报告录入</strong></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td  class="bg_table02"><div align="center">开工报告：</div></td>
    <td  class="bg_table02">
     <div align="left">
