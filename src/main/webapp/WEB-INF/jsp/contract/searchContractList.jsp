...
<table width="100%" border="0" align="center" id="sketchConList" >
  ...
  <s:iterator value="info.result" id="contract">
   <tr 
   <s:if test="#contract[0].conState==1">
   		onclick="openCon(<s:property value="#contract[0].conMainInfoSid"/>)" 
   </s:if>
   <s:else>
   		onclick="opentomanage(<s:property value="#contract[0].conMainInfoSid"/>)" 
   </s:else>
   onMouseOver="this.bgColor='#BBBBFF'; "  onMouseOut="this.bgColor='#FFFFFF';">
  
    <td width="231" align="center"  ><div align="center"><s:property value="#contract[0].conName"/></div></td>
    ...
    <td width="122"  align="center" ><div align="center"><s:property value="#contract[1].name"/></div></td>
    ...
    <td width="121"  align="center" ><div align="center"><s:property value="#contract[0].conTaxTamount"/></div></td>
    ...
    <td width="126"  align="center" ><div align="center"><s:property value="@com.baoz.yx.tools.ContractStateTool@getContractStateSnToName(#contract[0].conState)" /></div></td>
