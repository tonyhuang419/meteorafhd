    ...
    <td align="center"><table align="center"  border=0  cellpadding=1 cellspacing=1 width="100%" class="bg_table03">
        ...
        <tr class="bg_table03">
          ...
          <td width="49%" class="bg_table03"><div align="center">
            <input type="button" name="save" value="确认通过" onClick="confirmProject()" class="button01">
            <input type="button" name="save3232" value="确认退回" onClick="rollback()" class="button01">
          </div></td>
			...
			<table align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
				...
				<s:iterator value="info.result" id="projectlist" status="status">
					...
					<tr align="center">
						...
						<td  align="center" ><s:if test="#projectlist[0].conItemCostSure == 2">待确认</s:if><s:if test="#projectlist[0].conItemCostSure == 3">确认通过</s:if><s:if test="#projectlist[0].conItemCostSure == 4">确认退回</s:if></td>
					</tr>				
