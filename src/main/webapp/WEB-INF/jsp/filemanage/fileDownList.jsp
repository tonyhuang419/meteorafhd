		...
		<tr>
			...
			<table align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
				<tr align="center">
					...
					<td width="12%" class="bg_table01" align="left" nowrap>上传人</td>
					<td width="14%" class="bg_table01" align="left" nowrap>上传时间</td>
					<td width="14%" class="bg_table01" align="left" nowrap>文件名</td>
					<td width="14%" class="bg_table01" align="left" nowrap>类型</td>
					<td width="14%" class="bg_table01" align="left" nowrap>客户</td>
					<td width="20%" class="bg_table01" align="left" nowrap>文件说明</td>
				</tr>
				<s:iterator value="info.result" id="filedown" status="status">
					<tr align="center">
						...
						<td align="left" nowrap><s:date name="#filedown[0].filedate" format="yyyy-MM-dd" /></td>
