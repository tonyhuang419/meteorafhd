...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="bg_white" align="center">
	<tr> 
		...
		<table width="94%" border="0" cellspacing="1" cellpadding="1">
			<tr align="center">
			  <td class="bg_table02" align="right">到款金额：</td>
			  <td class="bg_table02" align="left"><s:textfield name="ri.amount"></s:textfield></td>
			 
		  </tr>
			<tr align="center">
			  <td class="bg_table02" align="right">到款方式：</td>
			...
			<tr align="center">
              <td class="bg_table02" align="right">到款时间：</td>
...
function check(){
	if(!validate()){
		var arriveAmount = <s:property value="ri.amount"></s:property>;
		var arriveInvoiceAmount = <s:property value="ii.invoiceAmount"></s:property>;
		var arriveTotalAmount = <s:property value="ii.receAmount"></s:property>;
