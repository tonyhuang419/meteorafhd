			...
			<table align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
				...
				<tr align="center">
					<td class="bg_table03" align="center"><input type="submit" name="SearchBtn" value="　新　  增　"
						...
						<input type="submit" name="deleteBtn" value="　删    除　" class="button01"
						onClick="deleteSelfProd()" disabled=true/></td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<table align="center" border="0" cellpadding="1" cellspacing="1" width="100%">
				...
				<s:iterator value="info.result" id="typeList" status="status">
					<tr align="center">
						...
						<td align="left" nowrap="true"><s:date name="#typeList[0].updateBy" format="yyyy-MM-dd" /></td>
