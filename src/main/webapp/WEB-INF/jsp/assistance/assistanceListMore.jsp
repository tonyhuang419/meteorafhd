    ...
    <td valign="top" align="center"><table width="96%" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        ...
        <tr align="center">
            ...
            <td class="bg_table02" align="left" colspan="3">徐同心</td>
          </tr>
          <tr align="center">
            <td align="right" class="bg_table02">外协供应商：</td>
            <td align="left" class="bg_table02"><s:property value="#result[1]"/></td>
            <td align="right" class="bg_table02">&nbsp;</td>
            <td align="left" class="bg_table02">&nbsp;</td>
          </tr>
          <tr align="center">
            <td class="bg_table02" align="right">项目名称：</td>
            <td width="33%" align="left" class="bg_table02"><s:property value="#result[2]" /></td>
            <td width="13%" align="right" class="bg_table02">项目号：</td>
            <td width="37%" align="left" class="bg_table02"><s:property value="#result[0].mainProjectId"/></td>
          </tr>
          <tr align="center">
            <td class="bg_table02" align="right">外协合同名称：</td>
            <td align="left" class="bg_table02"><label>
              <s:property value="#result[0].assistanceName"/>
            </label></td>
          ...
          <tr align="center">
            ...
            <td class="bg_table02" align="left"><s:property value="#result[0].contractMoney" /></td>
            <td class="bg_table02" align="right">&nbsp;</td>
            <td class="bg_table02" align="left">&nbsp;</td>
          </tr>
          <tr align="center">
            <td class="bg_table02" align="right">合同签订日期：</td>
            <td class="bg_table02" align="left"><s:property value="#result[0].contractDate" />
                </td>
            <td class="bg_table02" align="right">预计结束日期：</td>
            <td class="bg_table02" align="left"><s:property value="#result[0].endDate" />
                </td>
          </tr>
          <tr align="center">
            <td height="79" align="right" class="bg_table02">分包合同内容描述：</td>
            <td class="bg_table02" align="left" colspan="3" ><s:property value="#result[0].contractContent" /></td>
          </tr>
          </s:iterator>
          ...
          <tr class="bg_table03" align="center" style="height:42px">
            <td colspan="4"><table style="width:0%;100%">
                <tfoot class="bg_table03" style="height:42px">
                  <tr>
                    <td><input class="button01" type="button" name="gonext" value="确认通过" onClick=""></td>
                    <td align="right" colspan="2"><input class="button01" type="button" name="gonext" value="确认退回" onClick="javascript:window.close()"></td>
                  </tr> 
                </tfoot>
            </table></td>
          </tr>
