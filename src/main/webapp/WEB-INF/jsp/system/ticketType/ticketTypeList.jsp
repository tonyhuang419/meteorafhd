...
function add() 
{ 
location.href="../system/ticketType.action"; 
} 
function edit(){
...
<body>
<s:form action="ticketType.action">
		...
		<tr>
			...
			<table align="center" border=0 cellpadding="1" cellspacing=1
				...
				<tr align="center">
					...
					<td class="bg_table01">ID</td>
					<td class="bg_table01">开票类型名称</td>
					<td class="bg_table01">税率</td>
				</tr>
				...
				<s:iterator value="info.result">
					<tr align="center">
						...
						<td><s:property value="taxId" /></td>
						<td><s:property value="ticketTypeName" /></td>
