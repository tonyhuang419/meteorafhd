...
<s:form action="supplyQuery">
	<table width="100%" border="0" cellspacing="1" cellpadding="1"
		...
		<tr>
			...
			<tr class="bg_table03">
  <tr><td height="3" align="left" >当前页面:基础管理->供应商管理</td></tr>
			...
			<table align="center" border=0 cellpadding="1" cellspacing=1
				width="100%">
				<tr align="center">
				<td width="10%" class="bg_table01" align="center" nowrap="true">选择</td>
				...
				<s:iterator value="info.result">
						...
						<td><s:property value="typeManageService.getYXTypeManage(1013L,supplierType).typeName" /></td>
						<td><s:property value="nameOfInovice" /></td>
						<td><s:property value="billBank" /></td>
						<td><s:property value="billAccount" /></td>
						<td><s:property value="dutyParagraph" /></td>
